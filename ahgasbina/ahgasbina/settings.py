"""
Django settings for ahgasbina project.
...
CSRF_TRUSTED_ORIGINS = config(
    ...
    default="https://ahgasbina.fly.dev",
    cast=lambda v: [s.strip() for s in v.split(",")],
)
...
ROOT_URLCONF = "ahgasbina.ahgasbina.urls"
...
WSGI_APPLICATION = (
    "ahgasbina.ahgasbina.wsgi.application"
)
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './ahgasbina.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
